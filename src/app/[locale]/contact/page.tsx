      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="card-bg p-8 rounded-xl">
            <h2 className="text-3xl font-bold text-white mb-6 gold-text-gradient">
              Envoyez-nous un message
            </h2>

            {isSubmitted ? (
              <div className="text-center py-12">
                <div className="w-16 h-16 rounded-full bg-brand-green/20 flex items-center justify-center mx-auto mb-6 border border-brand-green">
                  <FontAwesomeIcon icon={faCheckCircle} className="text-brand-green text-2xl" />
                </div>
                <h3 className="text-2xl font-semibold text-white mb-4">Message envoyé !</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="livraison">Question de livraison</option>
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="btn-gold text-black font-bold py-3 px-8 rounded-full shadow-gold-glow w-full flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
